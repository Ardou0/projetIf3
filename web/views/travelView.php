...
<section class="filter-bar-container">
    <form id="filter-bar" method="POST" action="<?= URL ?>travel" class="filter-form">
        ...
        <div class="filter-item">
            ...
            <select id="destination" name="destination">
                <option value="" <?= empty($_POST['destination']) ? 'selected' : '' ?>>Sélectionner</option>
                <option value="paris" <?= (isset($_POST['destination']) && $_POST['destination'] == 'paris') ? 'selected' : '' ?>>Paris</option>
                <option value="new_york" <?= (isset($_POST['destination']) && $_POST['destination'] == 'new_york') ? 'selected' : '' ?>>New York</option>
                <option value="tokyo" <?= (isset($_POST['destination']) && $_POST['destination'] == 'tokyo') ? 'selected' : '' ?>>Tokyo</option>
            </select>
        </div>
        ...
        <div class="filter-item">
            ...
            <select id="people" name="people">
                <option value="" <?= empty($_POST['people']) ? 'selected' : '' ?>>Sélectionner</option>
                <option value="seul" <?= (isset($_POST['people']) && $_POST['people'] == 'seul') ? 'selected' : '' ?>>Seul</option>
                <option value="couple" <?= (isset($_POST['people']) && $_POST['people'] == 'couple') ? 'selected' : '' ?>>En couple</option>
                <option value="famille" <?= (isset($_POST['people']) && $_POST['people'] == 'famille') ? 'selected' : '' ?>>Famille</option>
            </select>
        </div>
        ...
        <div class="filter-item">
            <label for="duration-min">Durée (jours) :</label>
    ...
    <?php if (!empty($packages)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p class="no-offers-message">Aucune offre ne correspond à vos filtres. Veuillez essayer de changer les filtres.</p>
    <?php endif; ?>
</section>